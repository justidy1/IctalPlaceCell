...
def gen_spike_train(t_sim,STDP_ictal=False,seed=1234):

    # generate the maze
    L_maze = 300
    maze = LineMaze(3600,L=L_maze)

    t,x,y = gen_traj(maze,400,0.9,35)
    ...
    if STDP_ictal:
        ...
        r_rz_right = firing_ictal_spike(t,x,100,4,2000)
        r_rz_left = firing_ictal_spike(t,x,-100,4,2000)
